...
export const IconBacklog = ({ className = " " }: { className?: string }) => {
  return (
    <svg
      className={`customIcon ${className}`}
      xmlns="http://www.w3.org/2000/svg"
...
export const IconShuttle = ({ className = " " }: { className?: string }) => {
  return (
    <svg
      className={`customIcon ${className}`}
      xmlns="http://www.w3.org/2000/svg"
...
export const IconTodo = ({ className = " " }: { className?: string }) => {
  return (
    <svg
      className={`customIcon ${className}`}
      xmlns="http://www.w3.org/2000/svg"
...
export const IconDocuments = ({ className = " " }: { className?: string }) => {
  return (
    <svg
      className={`customIcon ${className}`}
      xmlns="http://www.w3.org/2000/svg"
...
export const IconCalender = ({ className = " " }: { className?: string }) => {
  return (
    <svg
      className={`customIcon ${className}`}
      xmlns="http://www.w3.org/2000/svg"
...
export const IconSortDesc = ({ className = " " }: { className?: string }) => {
  return (
    <svg
      className={`customIcon ${className}`}
      xmlns="http://www.w3.org/2000/svg"
